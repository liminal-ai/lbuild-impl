...
- Story implementation and progression. This is the default happy path for normal story work and should start with `story-orchestrate`: `phases/20-story-cycle.md`
